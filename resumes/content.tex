...
\newcommand{\then}{\textcolor{tertiary}{\textbf{$\Rightarrow$}}\space}

\newcommand{\keybase}{\textcolor{keybase}{\href{https://keybase.io/ethan605}{\faKey}}}
\newcommand{\github}{\textcolor{github}{\href{https://github.com/ethan605}{\faGithub}}}
\newcommand{\linkedin}{\textcolor{linkedin}{\href{https://linkedin.com/in/ethan605}{\faLinkedin}}}
...
\begin{tabularx}{\textwidth}{@{} >{\raggedleft}p{2.25cm} | X @{}}
  Aug 2020 & \primary{Senior Software Engineer} \at \secondary{Onfido} \tertiary{(London, UK)} \\
 - Present & As a member of End User Experience team, I develop backend services with Python, Elixir, Ruby on Rails,
  ...
  \\
  Sep 2019 & \primary{Senior Software Engineer} \at \secondary{Pi-top} \tertiary{(UK Remote)} \\
- Jul 2020 & \tbullet Developed new features in both backend and frontend for Further, a learning-by- \\
  ...
  \\
  Aug 2016 & \primary{Senior Software Engineer} \at \secondary{WeFit} \tertiary{(Hanoi, Vietnam)} \\
- Aug 2019 & \tbullet In charge of the architecture and the design of WeFit mobile application, an online-to- \\
  ...
  \\
  Aug 2014 & \primary{Dev Lead} \then \primary{Head of Operations} \at \secondary{TOPICA Edtech Group} \tertiary{(Hanoi, Vietnam)} \\
- Aug 2016 & \tbullet Managed Operations department of 30 to connect 200+ instructors and create 500+ \\
  ...
  \\
  Aug 2012 & \primary{Mobile Developer} \then \primary{Dev Lead} \at \secondary{Vinova Pte. Ltd.} \tertiary{(Hanoi, Vietnam)} \\
- Sep 2014 & \tbullet Led a team of 3 to develop 5 different mobile applications for Singapore marketplace. \\
  ...
  \\
  Aug 2009 & \primary{Undergrad} \at \secondary{Vietnam National University, Hanoi} \tertiary{(Hanoi, Vietnam)} \\
- May 2013 & Bachelor's Degree, Computer Science. \\
\end{tabularx}

\subsection*{VERSION \normalsize\texttt{2022.feb.20}}
